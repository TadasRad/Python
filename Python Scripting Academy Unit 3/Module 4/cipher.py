...
def parse_command_line():
    ...
    parser.add_argument('infile',type=str, action='store', help = 'input file to be encrypted or decrypted')
    parser.add_argument('-o', '--outfile', metavar = 'outfile_path', help = 'output file')
    parser.add_argument('-k', '--key', metavar = 'KEY',type=int, help = 'encryption/decryption key (must be positive) (default= 1)', default=1)
    parser.add_argument('-d', '--decrypt',help = 'decrypt the input file')
    parser.add_argument('-a', '--all',action ='store_const' , const =[1, 25], help = 'decrypt using all keys [1, 25], save outputs in different files. (useful in case the key is lost or unknown)')
...
def read_file(file_path):
    ...
    try:
        ...
        print("Something when wrong when opening the file to read")
...
def write_file(message, file_path):
    ...
    try:
        ...
        print("Something when wrong when opening the file to write")
...
def transform(message, key, decrypt):
    ...
    for letter in message:
        if letter.isalpha():
            ...
            transformed_message = transformed_message + letter
        else:
            transformed_message = transformed_message + letter
